(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
            ...
            var vm = new Vue({
                ...
                data: {
                    ...
                    items: [{
                            title: '坦克大戰',
                            text: '使用Html5、Css3、Javascript，並運用canvas，仿製任天堂紅白機經典遊戲坦克大戰.',
                            url: 'javascript:void(0);',
                            image: 'https://unsplash.it/650/350/?image=111'
                        },
                        {
                            title: '期交所-臺股期貨契約',
                            text: '在學時，使用爬蟲讀取期交所網站期貨相關資料並產生Excel報表，協助於金融業工作的朋友增加工作效率.',
                            url: 'javascript:void(0);',
                            image: 'https://unsplash.it/650/350/?image=534'
                        },
                        {
                            title: '台鐵購票小幫手',
                            text: '因出遊花蓮購票需要，使用Javascript將購票人與車次資訊自動填入頁面，並依中原標準時間輔助購票.',
                            url: 'javascript:void(0);',
                            image: 'https://unsplash.it/650/350/?image=9'
                        },
                        {
                            title: '設備小幫手',
                            text: '在因打工需要，使用爬蟲讀取學校教室系統設備異常警示，當發現有異常時會跳出通知告知人員前往處理.',
                            url: 'javascript:void(0);',
                            image: 'https://unsplash.it/650/350/?image=12'
                        },
                        {
                            title: 'e化企業系統',
                            text: '使用ASP.NET開發、維護可樂旅遊ERP系統，讓使用者作業上更快速便利，增加工作效率.',
                            url: 'javascript:void(0);',
                            image: 'https://unsplash.it/650/350/?image=15'
                        },
                        {
                            title: '可樂旅遊同業服務網',
                            text: '參與開發機票電子商務系統、下單系統，從資料建立到商業邏輯與資料呈現以及訂單成立，學習到許多程式開發與設計經驗.',
                            url: 'javascript:void(0);',
    ...
    3: [function(require, module, exports) {
        ...
        module.exports = {
            ...
            computed: {
                ...
                linkStyles: function linkStyles() {
                    return {
                        height: this.computedHeight
                    };
                },
                liStyles: function liStyles() {
                    return {
        ...
        if (module.hot) {
            (function() {
                ...
                var id = "/home/colo/Proyectos/ARMAR/node_modules/vue-accordion/src/vue-accordion-partial.vue"
    ...
    }, { "vue": 6, "vue-hot-reload-api": 5, "vueify-insert-css": 7 }],
    4: [function(require, module, exports) {
        var __vueify_style__ = require("vueify-insert-css").insert("\n\t.accordion {\n\t\twidth: 100%;\n\t\toverflow: hidden;\n    }\n\n    .accordion ul {\n\t\twidth: 100%;\n\t\tdisplay: table;\n\t\ttable-layout: fixed;\n\t\tmargin: 0;\n\t\tpadding: 0;\n    }\n")
        'use strict';

        var partialAccordion = require('./vue-accordion-partial.vue');
        ...
        module.exports = {
            ...
            computed: {
                styles: function styles() {
                    ...
                    if (this.maxWidth !== 0) styles.maxWidth = this.maxWidth + 'px';

                    return styles;
                }
            },
            components: {
                partialAccordion: partialAccordion
            }
        };
        if (module.exports.__esModule) module.exports = module.exports.default;
        (typeof module.exports === "function" ? module.exports.options : module.exports).template = "\n<div :class=\"class\" :style=\"styles\">\n\t<ul>\n\t\t<partial-accordion v-for=\"item in items\" :top=\"top\" :item=\"item\" :height=\"height\"></partial-accordion>\n\t</ul>\n</div>\n"
        if (module.hot) {
            (function() {
                module.hot.accept()
                var hotAPI = require("vue-hot-reload-api")
                hotAPI.install(require("vue"), true)
                if (!hotAPI.compatible) return
                var id = "/home/colo/Proyectos/ARMAR/node_modules/vue-accordion/src/vue-accordion.vue"
                module.hot.dispose(function() {
                    require("vueify-insert-css").cache["\n\t.accordion {\n\t\twidth: 100%;\n\t\toverflow: hidden;\n    }\n\n    .accordion ul {\n\t\twidth: 100%;\n\t\tdisplay: table;\n\t\ttable-layout: fixed;\n\t\tmargin: 0;\n\t\tpadding: 0;\n    }\n"] = false
                    document.head.removeChild(__vueify_style__)
                })
    ...
    }, { "./vue-accordion-partial.vue": 3, "vue": 6, "vue-hot-reload-api": 5, "vueify-insert-css": 7 }],
    5: [function(require, module, exports) {
        ...
        function injectHook(options, name, hook) {
            ...
            options[name] = existing ?
                ...
                existing.concat(hook) : [existing, hook] : [hook]
        }
